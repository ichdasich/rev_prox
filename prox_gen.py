...
idx.write('<h3>         DO NOT LOG INTO ANY SITES ACCESSIBLE VIA THIS SERVICE!</h3>\n')
idx.write('<h3>         DO NOT ENTER ANY CREDENTIALS!</h3>\n')
idx.write('<h3>         USE THE TOR BROWSER <a href="https://www.torproject.org/">https://www.torproject.org/</a> (PROXY BELOW)</h3>\n')
idx.write('</p>\n')
idx.write('</br>')
idx.write('</br>')
for s in SITES:
