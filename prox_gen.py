...
idx.write('<h3 align="center" style="color:#FF0000;">Внимание: этот сервис предназначен для обхождения цензуры.</h3>\n')
...
idx.write('<h5 align="center" style="color:#FF0000;">ДЛЯ ВХОДА НА САЙТЫ: используйте браузер Тор: <a href="https://www.torproject.org/">https://www.torproject.org/</a> (PROXY BELOW)</h5>\n')
idx.write('<h3 align="center">- - - - - - - - - - - - - </h3>\n')
