...
idx.write('<h5 align="center" style="color:#FF0000;">INSTEAD OF THIS SERVICE: USE THE TOR BROWSER <a href="https://www.torproject.org/">https://www.torproject.org/</a> (PROXY BELOW)</h5>\n')
idx.write('<h3 align="center">- - - - - - - - - - - - - </h3>\n')
idx.write('<h3 align="center" style="color:#FF0000;">Внимание: этот сервис предназначен для обхождения цензуры и ломает шифровку.</h3>\n')
idx.write('<h3 align="center">Не пытайтесь залогиниться через любые сайты доступные через этот сервис! Не вводите никаких данных! этот сервис не предоставляет анонимности от местных властей!</h3>\n')
